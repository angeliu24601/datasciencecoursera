## 1. Suppose I conduct a study and publish my findings. Which of the following is
##    an example of a replication of my study?
## - An investigator at another institution conducts a study addressing
##   a different scientific question and publishes her findings.
## - I take my own data, analyze it again, and publish new findings.
## *- An investigator at another institution conducts a study addressing
##   the same question, collects her own data, analyzes it separately from me,
##   and publishes her own findings.
## - I give my data to an independent investigator at another institution,
##   she analyzes the data and gets the same results as I originally obtained.

## 2. Which of the following is a requirement for a published data analysis
##    to be reproducible?
...
## - The study's original authors re-run their computer code on their analytic
##   data and confirm publicly that the findings match those of the published results.
...
##   publicly available. When the code is run on the analytic data,
##   the findings are identical to the published results.
...
## *- The original study was opportunistic in its timing and it would be
##   difficult to find a similar context in which to repeat it.
## - The original study was published in a high impact journal
...
## 5. Which of the following is a reason why publishing reproducible research
##    is increasingly important?
## *- New technologies are increasing the rate of data collection,
##   creating datasets that are more complex and extremely high dimensional.
